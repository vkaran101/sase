  ...
  <div class="row body-row">
    ...
    <ol class="accordion" data-accordion>
      <li class="accordion-navigation">
        <a href="#opt1">
          <b>From the north (via Route I-93 or Route 1)</b>
        </a>
      ...
      <li class="accordion-navigation">
        <a href="#opt2">
          <b>From the west (via Route I-90, Massachusetts Turnpike)</b>
        </a>
      ...
      <li class="accordion-navigation">
        <a href="#opt4">
          <b>From the south (via I-93, Route 3)</b>
        </a>
      ...
      <li class="accordion-navigation">
        <a href="#opt5">
          <b>From Logan Airport</b>
        </a>
        <div id="opt5" class="content">
      ...
      <li class="accordion-navigation">
        <a href="#opt6">
          <b>Via public transportation</b>
        </a>
        <div id="opt6" class="content">
